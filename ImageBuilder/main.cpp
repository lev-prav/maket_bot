...
{
    // Read the images
    Mat foreground = imread("/home/lev/data/projects/tgBotCpp/res/textures/РАЗДЕЛ - 3 (ПОТОЛОК)/3_plitka_2.png");
    ...
    inputQuad[1] = Point2f( 399.f, 0.f);
    inputQuad[2] = Point2f( 0.f, 399.f);
    inputQuad[3] = Point2f( 399.f, 399.f);
    // The 4 points where the mapping is to be done , from top-left in clockwise order
    outputQuad[0] = Point2f( 0.f, 0.f );
    outputQuad[1] = Point2f( 1600.f - 1,0.f);
